              ...
              <div className='flex gap-2.5 max-[500px]:gap-1'>
                {
                  ...
                  return (
                    <div className='flex items-center justify-center w-16 h-16 max-[500px]:h-11 max-[500px]:w-11  rounded-full border-[1px] border-[#e6e6e6] text-[26px] text-[#ec222c] font-[500]' key={index}>
                      {
                        item
                      }
                    </div>
