                            ...
                            item.map((item2: any, index2: number) => {
                                if(typeof item2 === 'string'){
                                    if(item2 === "Xổ số Thủ Đô")
                                        return (
                                            <Link className="border border-[#000]" href={`/ket-qua-xo-so-mien-bac.html`}>
                                                <div key={index2}>
                                                    {item2}
                                                </div>
                                            </Link>
                                    ...
                                    return (
                                        <Link className="border border-[#000]" href={`/ket-qua-xo-so/ket-qua-xo-so-${tinhToUrl({ten: item2.replaceAll("Xổ số ", "")})}.html`}>
                                ...
                                return <div className="border border-[#000] pl-4" key={index2}>
                                        ...
                                        return (
                                            <Link className="" href={`/ket-qua-xo-so/ket-qua-xo-so-${tinhToUrl({ten: item3.replaceAll("Xổ số ", "")})}.html`}>
                                                <div key={index3}>
                                                    {item3}
                                                </div>
                                            </Link>)
