  ...
  return (
    <Layout>
      <div className="flex flex-col gap-4">
        <div className="">
          <div className="flex justify-center text-center items-center bg-[#ec222c] text-[20px] font-bold text-[#fff]">
              Xổ Số - Kết Quả Xổ Số Hôm Nay - Kết Quả Xổ Số 3 Miền
          </div>
          <div className="grid grid-cols-3 grid-rows-4 bg-[#fff]">
            <div className="flex items-center pl-3 text-[16px] text-[#0029ad]  font-[500] border-[1px] border-t-0 border-solid border-[#b9b9b9]">
              XS Miền Bắc
            </div>
            <div className="flex items-center pl-3 text-[16px] text-[#0029ad]  font-[500] border-[1px] border-t-0 border-solid border-[#b9b9b9]">
              XS Miền Nam
            ...
            </div>
            {
              dataRule.nam.tinh.map((item: any, index: number) => {
                return (
                  <div className="flex items-center pl-3 text-[16px] text-[#0029ad] font-[500] border-[1px] border-t-0 border-solid border-[#b9b9b9]" key={index}>
                    {
                      item.ten
                    }
                  </div>
            ...
            <div className="flex items-center pl-3 text-[16px] font-[500] border-[1px] border-t-0 border-solid border-[#b9b9b9]">
            </div>
            <div className="flex items-center pl-3 text-[16px] font-[500] border-[1px] border-t-0 border-solid border-[#b9b9b9]">
            </div>
          </div>
